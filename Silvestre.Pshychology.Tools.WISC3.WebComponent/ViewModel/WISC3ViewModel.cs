...
using Silvestre.Pshychology.Tools.WISC3.WebComponent.ViewModel.Charts;
using System;
using System.Linq;
...
namespace Silvestre.Pshychology.Tools.WISC3.WebComponent.ViewModel
{
    public class WISC3ViewModel
    {
        ...
        {
            if (IsAgeWithinBounds() && AreAllMandatoryTestComplete())
            {
        ...
        private bool IsAgeWithinBounds()
        {
            return this.StanderdizationPhase.IsAgeSupported(this.SubjectAge);
        }
