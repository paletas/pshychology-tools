...
namespace Silvestre.Psychology.Tools.WISC3.ViewModels.Charts
{
    public class WISC3StandardFactorialIndicesChartViewModel
    {
        ...
        {
            Labels = new string[] { "Inf", "Sem", "Voc", "Com", "CG", "DG", "Cb", "CO", "Cd", "PS" };

            VerbalComprehension = new short?[]
            {
            ...
            PerceptiveOrganization = new short?[]
            {
                null, null, null, null,
